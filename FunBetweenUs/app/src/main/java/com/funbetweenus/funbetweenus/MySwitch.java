...
public class MySwitch extends CompoundButton {
    ...
    public MySwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbDrawable = a.getDrawable(R.styleable.MySwitch_sw_thumb);
        mTrackDrawable = a.getDrawable(R.styleable.MySwitch_sw_track);
        mTextOn = a.getText(R.styleable.MySwitch_sw_textOn);
        mTextOff = a.getText(R.styleable.MySwitch_sw_textOff);
        mDrawableOn = a.getDrawable(R.styleable.MySwitch_sw_drawableOn);
        mDrawableOff = a.getDrawable(R.styleable.MySwitch_sw_drawableOff);
        mPushStyle = a.getBoolean(R.styleable.MySwitch_sw_pushStyle, false);
        mTextOnThumb = a.getBoolean(R.styleable.MySwitch_sw_textOnThumb, false);
        mThumbExtraMovement = a.getDimensionPixelSize(R.styleable.MySwitch_sw_thumbExtraMovement, 0);
        mThumbTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_sw_thumbTextPadding, 0);
        mTrackTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_sw_trackTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize( R.styleable.MySwitch_sw_switchMinWidth, 0);
        mSwitchMinHeight = a.getDimensionPixelSize( R.styleable.MySwitch_sw_switchMinHeight, 0);
        mSwitchPadding =  a.getDimensionPixelSize( R.styleable.MySwitch_sw_switchPadding, 0);
        ...
        int appearance = a.getResourceId(R.styleable.MySwitch_sw_switchTextAppearanceAttrib, 0);
        if (appearance != 0) {
